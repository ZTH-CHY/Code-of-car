...
#define ICM42688_SPI                        (SPI_2)                                 // 硬件 SPI 号
#define ICM42688_SPC_PIN                    (SPI2_CLK_P15_2)                       // 硬件 SPI SCK 引脚
#define ICM42688_SDI_PIN                    (SPI2_MOSI_P15_1)                      // 硬件 SPI MOSI 引脚
#define ICM42688_SDO_PIN                    (SPI2_MISO_P15_0)                      // 定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#else
...
//#define ICM42688_CS_MODULE      P10
#define ICM42688_CS_PIN         P15_3

// 对ICM42688的CS管脚进行高低电平操作
#define ICM42688_CS_LEVEL(level)        gpio_set_level(ICM20602_CS_PIN,level);
